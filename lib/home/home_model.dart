...
class HomeModel extends FlutterFlowModel {
  ...
  // State field(s) for dropdown-staff widget.
  String? dropdownStaffValue;
  FormFieldController<String>? dropdownStaffValueController;
  // State field(s) for dropdown-admin widget.
