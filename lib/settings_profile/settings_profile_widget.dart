...
class _SettingsProfileWidgetState extends State<SettingsProfileWidget> {
  ...
  void initState() {
    ...
    _model.textController5 ??= TextEditingController(text: currentUserUid);
