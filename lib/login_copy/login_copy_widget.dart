  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<AddStaffRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AddStaffRecord> loginCopyAddStaffRecordList = snapshot.data!;
        final loginCopyAddStaffRecord = loginCopyAddStaffRecordList.isNotEmpty
            ? loginCopyAddStaffRecordList.first
            : null;
