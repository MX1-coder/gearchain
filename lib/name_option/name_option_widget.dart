...
import 'name_option_model.dart';
export 'name_option_model.dart';

class NameOptionWidget extends StatefulWidget {
  const NameOptionWidget({
    Key? key,
    this.titleName,
  }) : super(key: key);
  ...
  @override
  _NameOptionWidgetState createState() => _NameOptionWidgetState();
}

class _NameOptionWidgetState extends State<NameOptionWidget> {
  late NameOptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NameOptionModel());
