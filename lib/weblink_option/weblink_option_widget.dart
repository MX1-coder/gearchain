...
import 'weblink_option_model.dart';
export 'weblink_option_model.dart';

class WeblinkOptionWidget extends StatefulWidget {
  const WeblinkOptionWidget({
    Key? key,
    this.titleName,
  }) : super(key: key);
  ...
  @override
  _WeblinkOptionWidgetState createState() => _WeblinkOptionWidgetState();
}

class _WeblinkOptionWidgetState extends State<WeblinkOptionWidget> {
  late WeblinkOptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WeblinkOptionModel());
