                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      '5yph8nlb' /*  Form has been created.  */,
                                                                    ),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                      ...
                                      Container(
                                        ...
                                        child: StreamBuilder<
                                            List<AddUserNotificationRecord>>(
                                          stream:
                                              queryAddUserNotificationRecord(),
                                          builder: (context, snapshot) {
                                            // Customize what your widget looks like when it's loading.
                                            if (!snapshot.hasData) {
                                              return Center(
                                            ...
                                            List<AddUserNotificationRecord>
                                                columnAddUserNotificationRecordList =
                                                snapshot.data!;
                                            return SingleChildScrollView(
                                              child: Column(
                                                mainAxisSize: MainAxisSize.min,
                                                ...
                                                children: List.generate(
                                                    columnAddUserNotificationRecordList
                                                        .length, (columnIndex) {
                                                  final columnAddUserNotificationRecord =
                                                      columnAddUserNotificationRecordList[
                                                          columnIndex];
                                                  return Padding(
                                                    padding:
                                                      ...
                                                      children: [
                                                        Row(
                                                          ...
                                                          children: [
                                                            Expanded(
                                                              child: Text(
                                                                columnAddUserNotificationRecord
                                                                    .addUserNotification,
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              Text(
                                                                '${columnAddUserNotificationRecord.addUserNotification}'
                                                                    .maybeHandleOverflow(
                                                                        maxChars:
                                                                            8),
                                                                style: FlutterFlowTheme.of(
                                                      ...
                                                      children: [
                                                        Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'y0ijxcw0' /* Sofa is less than 5 now. */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
              ...
              child: Container(
                ...
                child: StreamBuilder<List<NotificationRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<NotificationRecord> rowNotificationRecordList =
                        snapshot.data!;
                    // Return an empty Container when the item does not exist.
                    if (snapshot.data!.isEmpty) {
                      return Container();
                    }
                    final rowNotificationRecord =
                        rowNotificationRecordList.isNotEmpty
                            ? rowNotificationRecordList.first
                            : null;
                    return InkWell(
                      splashColor: Colors.transparent,
                      focusColor: Colors.transparent,
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        await rowNotificationRecord!.reference.delete();
                      },
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
